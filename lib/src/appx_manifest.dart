...
<Package xmlns="http://schemas.microsoft.com/appx/manifest/foundation/windows10" 
  ...
  String _getExtensions() {
    if (!_config.executionAlias.isNull || _config.protocolActivation.isNotEmpty || !_config.fileExtension.isNull /*|| !_config.toastActivatorCLSID.isNull*/ || (_config.appUriHandlerHosts != null && _config.appUriHandlerHosts!.isNotEmpty) || _config.enableAtStartup || _config.enableContextMenu) {
      return '''<Extensions>
      ...
      ${_config.enableContextMenu ? _getContextMenuExtension() : ''}
      </Extensions>''';
  ...
  _getContextMenuExtension() {
    return '''<desktop4:Extension Category="windows.fileExplorerContextMenus">
          <desktop4:FileExplorerContextMenus>
            ${_config.contextMenuDirectoryId != null ? '''<desktop5:ItemType Type="Directory">
              <desktop5:Verb Id="${_config.contextMenuDirectoryId}" Clsid="${_config.contextMenuDirectoryClsid}" />
            </desktop5:ItemType>''' : ''}
            ${_config.contextMenuBackgroundId != null ? '''<desktop5:ItemType Type="Directory\\Background">
              <desktop5:Verb Id="${_config.contextMenuBackgroundId}" Clsid="${_config.contextMenuBackgroundClsid}" />
            </desktop5:ItemType>''' : ''}
            ${_config.contextMenuFilesId != null ? '''<desktop5:ItemType Type="*">
              <desktop5:Verb Id="${_config.contextMenuFilesId}" Clsid="${_config.contextMenuFilesClsid}" />
            </desktop5:ItemType>''' : ''}
          </desktop4:FileExplorerContextMenus>
        </desktop4:Extension>
        <com:Extension Category="windows.comServer">
          <com:ComServer>
            <com:SurrogateServer DisplayName="Context menu verb handler">
              <com:Class Id="${_config.comSurrogateServerClassId}" Path="${_config.comSurrogateServerName}" ThreadingModel="STA"/>
            </com:SurrogateServer>
          </com:ComServer>
      </com:Extension>''';
  }
